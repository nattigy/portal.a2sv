...
import {
  GroupTopicSeasonService,
  GroupTopicSeasonWhereInput,
} from './group-topic-season.service'
...
export class GroupTopicSeasonResolver {
  ...
  createGroupTopicSeason(
    ...
    return this.groupTopicSeasonService.createGroupTopicSeason(
      createGroupTopicSeasonInput,
    )
  }

  @Query(() => [GroupTopicSeason], { name: 'groupTopicSeason', nullable: true })
  groupTopicSeasons(
    @Args('filter', { type: () => GroupTopicSeasonWhereInput })
    filter: GroupTopicSeasonWhereInput,
  ) {
  ...
  groupTopicSeason(
    ...
    return this.groupTopicSeasonService.groupTopicSeason(
      groupId,
      topicId,
      seasonId,
    )
