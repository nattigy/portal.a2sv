...
export class UserGroupSeasonContestService {
  ...
  async userGroupSeasonContest({ userId, seasonId, contestId, groupId }: UserGroupSeasonContestId): Promise<UserGroupSeasonContest> {
  ...
  async userGroupSeasonContests(
    filterUserGroupSeasoContestInput: FilterUserGroupSeasonContestInput,
    ...
    const count = await this.userGroupSeasonContestRepository.count(
      filterUserGroupSeasoContestInput,
    )
    ...
    const UserGroupSeasonContests: UserGroupSeasonContest[] =
      await this.userGroupSeasonContestRepository.findAll({
        skip,
        take,
        where: filterUserGroupSeasoContestInput,
      })
  ...
  async updateUserGroupSeasonContest(
    { id, ...updates }: UpdateUserGroupSeasonContestInput): Promise<UserGroupSeasonContest> {
