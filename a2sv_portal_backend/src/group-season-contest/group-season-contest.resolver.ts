...
export class GroupSeasonContestResolver {
  ...
  createGroupSeasonContest(@Args('createGroupSeasonContestInput') createGroupSeasonContestInput: CreateGroupSeasonContestInput) {
  ...
  @Mutation(() => GroupSeasonContest)
  updateGroupSeasonContest(@Args('updateGroupSeasonContestInput') updateGroupSeasonContestInput: UpdateGroupSeasonContestInput) {
    return this.groupSeasonContestService.update(updateGroupSeasonContestInput.id, updateGroupSeasonContestInput);
  }
