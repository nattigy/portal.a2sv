...
export class GroupSeasonResolver {
  ...
  createGroupSeason(@Args('createGroupSeasonInput') createGroupSeasonInput: CreateGroupSeasonInput) {
  ...
  @Mutation(() => GroupSeason)
  updateGroupSeason(@Args('updateGroupSeasonInput') updateGroupSeasonInput: UpdateGroupSeasonInput) {
