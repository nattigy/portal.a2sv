...
const testContestArray = [
  { name: testName, link : testlink, div:testDiv, id:testId, startTime:testStartTime, endTime:testEndTime,
    problems:{problemId:'1', testProblems}},
  { name: 'contest 2', link: 'link2',div:'Div 1', id:uuidv4(), startTime:testStartTime, endTime:testEndTime,problems:{problemId:'2', testProblems}},
  { name: 'contest 3', link3: 'link3', div:'Div 3',id:uuidv4(), startTime:testStartTime, endTime:testEndTime,problems:{problemId:'3', testProblems}},
];
