...
export class SeasonTopicProblemUserResolver {
  ...
  createSeasonTopicProblemUser(@Args('createSeasonTopicProblemUserInput') createSeasonTopicProblemUserInput: CreateSeasonTopicProblemUserInput) {
  ...
  @Mutation(() => SeasonTopicProblemUser)
  updateSeasonTopicProblemUser(@Args('updateSeasonTopicProblemUserInput') updateSeasonTopicProblemUserInput: UpdateSeasonTopicProblemUserInput) {
    return this.seasonTopicProblemUserService.update(updateSeasonTopicProblemUserInput);
  }

  @Mutation(() => SeasonTopicProblemUser)
  removeSeasonTopicProblemUser(@Args('id', { type: () => Int }) id: UpdateSeasonTopicProblemUserInput) {
