...
export class GroupTopicProblemUserResolver {
  constructor(private readonly groupTopicProblemUserService: GroupTopicProblemUserService) {}

  @Mutation(() => GroupTopicProblemUser)
  createGroupTopicProblemUser(@Args('createGroupTopicProblemUserInput') createGroupTopicProblemUserInput: CreateGroupTopicProblemUserInput) {
    return this.groupTopicProblemUserService.create(createGroupTopicProblemUserInput);
  }
  ...
  @Mutation(() => GroupTopicProblemUser)
  updateGroupTopicProblemUser(@Args('updateGroupTopicProblemUserInput') updateGroupTopicProblemUserInput: UpdateGroupTopicProblemUserInput) {
    return this.groupTopicProblemUserService.update(updateGroupTopicProblemUserInput.id, updateGroupTopicProblemUserInput);
  }
