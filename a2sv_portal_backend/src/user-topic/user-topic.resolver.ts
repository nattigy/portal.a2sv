...
export class UserTopicResolver {
    ...
    @Mutation(() => UserTopic)
    createUserTopic(@Args('createUserTopicInput') createUserTopicInput: CreateUserTopicInput) {
    ...
    @Mutation(() => UserTopic)
    updateUserTopic(@Args('updateUserTopicInput') updateUserTopicInput: UpdateUserTopicInput) {
        return this.userTopicService.update(updateUserTopicInput.id, updateUserTopicInput);
    }
