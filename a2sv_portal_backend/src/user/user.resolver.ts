...
import {
    GroupTopicSeasonProblemUser
} from '../group-topic-season-problem-user/entities/group-topic-season-problem-user.entity'
...
export class UserResolver {
    ...
    @Mutation(() => User)
    async updateComfortLevel(@Args('topicId', {type: () => Int}) topicId: number, @Args('userId', {type: () => Int}) userId: number, @Args('comfortLevel', {type: () => ComfortLevel}) comfortLevel: ComfortLevel) {
        try {
