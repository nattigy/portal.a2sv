...
export class GroupSeasonContestProblemResolver {
  constructor(private readonly groupSeasonContestProblemService: GroupSeasonContestProblemService) {}

  @Mutation(() => GroupSeasonContestProblem)
  createGroupSeasonContestProblem(@Args('createGroupSeasonContestProblemInput') createGroupSeasonContestProblemInput: CreateGroupSeasonContestProblemInput) {
  ...
  @Mutation(() => GroupSeasonContestProblem)
  updateGroupSeasonContestProblem(@Args('updateGroupSeasonContestProblemInput') updateGroupSeasonContestProblemInput: UpdateGroupSeasonContestProblemInput) {
    return this.groupSeasonContestProblemService.update(updateGroupSeasonContestProblemInput.id, updateGroupSeasonContestProblemInput);
  }
