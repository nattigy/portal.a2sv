            ...
            <Box sx={{
                ...
                <Box rowGap={10} display="flex" flexDirection="column" alignItems="center">
                    ...
                    <Box display="flex" rowGap={2} flexDirection="column" justifyItems="center" alignItems="center">
                        <Typography fontWeight="bold" variant="h3">{title}</Typography>
                        <Typography variant="h6" width={200} align="center">{description}</Typography>
                        <Button color="primary" variant="contained" onClick={action}>{actionTitle}</Button>
                    </Box>
                </Box>
            </Box>
        </div>
