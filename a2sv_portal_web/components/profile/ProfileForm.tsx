...
import { Button, FormLabel, InputAdornment, MenuItem, Stack, TextField, Typography } from '@mui/material';
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Full Name</Typography>
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Email</Typography>
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Username</Typography>
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Country</Typography>
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Biography</Typography>
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Work Status</Typography>
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Current Education <br /> Status</Typography>
                            ...
                            <Box width="70%">
                                <CustomTextField
                                    ...
                                    onChange={formik.handleChange}
                                    error={formik.touched.curr_education_status && Boolean(formik.errors.curr_education_status)}
                                    helperText={formik.touched.curr_education_status && formik.errors.curr_education_status}
                                    select
                                >
                                    {[{
                                        value: "year1",
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Mentor</Typography>
                                </FormLabel>
                            </Box>
                            <Box width="70%">
                                <CustomTextField
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1" sx={{
                                        // fontWeight: "bold",
                                    }}>T-shirt Size</Typography>
                                </FormLabel>
                            </Box>
                            <Box width="70%">
                                <CustomTextField
