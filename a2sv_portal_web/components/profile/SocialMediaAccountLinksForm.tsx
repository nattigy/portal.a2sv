                                    ...
                                    <Box sx={{
                                        ...
                                        >
                                            <FormLabel sx={{
                                                ...
                                                <Stack sx={{
                                                    ...
                                                    <Box display="flex" justifyContent="center" alignItems="center" width="25px" height="25px">
                                                        <img width="100%" height="100%" src={`/assets/imgs/icons/${smAccount.icon}.svg`} alt={smAccount.label} />
                                                    </Box>
                                                    <Typography color="CaptionText" variant="subtitle1">{smAccount.label}</Typography>
                                                </Stack>
                                            </FormLabel>
                                        </Box>
                                        <Box
                                        ...
                                        >
                                            <CustomTextField
                                                ...
                                                error={formik.touched[smAccount.value] && Boolean(formik.errors[smAccount.value])}
                                                ...
                                                InputProps={{
                                                    ...
                                                    >{smAccount.domain}</InputAdornment>,
                                                }}
                                            />
                                        </Box>
                                    </Box>
