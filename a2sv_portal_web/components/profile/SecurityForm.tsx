                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Old Password</Typography>
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">New Password</Typography>
                        ...
                        <Stack direction="row" alignItems="flex-start" spacing={2}>
                            <Box width="30%">
                                <FormLabel sx={{
                                    ...
                                    <Typography color="CaptionText" variant="subtitle1">Confirm New Password</Typography>
