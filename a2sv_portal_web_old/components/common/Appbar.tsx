    ...
    >
      <AppBar
        ...
        sx={{
          ...
          alignItems: 'center',
          padding: { xs: '15px 5px', sm: '10px 15px', lg: '15px 20px' },
          height: { xs: '120px', md: '72px' },
        }}
      >
        <Toolbar
          disableGutters
        ...
        >
            ...
            >
              ...
              >
                ...
                <Box sx={{ height: { xs: '40px', md: '60px' } }}>
                  <Link
                    href="/"
                    className="MuiTypography-root MuiLink-root MuiLink-underlineHover MuiTypography-button MuiTypography-colorPrimary"
                  >
                    <img
                      alt="Logo enterprise"
                      width="100%"
          ...
          >
            <Box
              sx={{
                display: 'flex',
                xs: { flexGrow: 1, justifyContent: 'space-between' },
                md: { flexGrow: 0 },
              }}
            >
              {props.handleDrawerToggle && (
