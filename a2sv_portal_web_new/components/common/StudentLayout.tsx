...
const StudentLayout = ({ sidebar, children }: LayoutProps) => {
    ...
    return (
        <div className="flex flex-1 bg-gray-50 min-h-screen">
                ...
                <div className="min-h-full flex flex-col  flex-grow py-5 overflow-y-auto bg-white">
                    <div className="flex justify-center items-center">
                        <div className="border flex items-center justify-center w-14 h-14 rounded-xl bg-primary">
                            <svg width="20" height="23" viewBox="0 0 20 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.981 5.2742C9.61765 6.09955 9.26345 6.90401 8.9098 7.70846C8.11138 9.52525 7.31296 11.3426 6.51454 13.1594C6.10104 14.1 5.67245 15.0338 5.27566 15.9818C4.75219 17.2325 3.40711 17.1828 2.737 16.3874C2.32512 15.8987 2.29817 15.327 2.54939 14.748C3.07341 13.5407 3.60982 12.3391 4.14138 11.1353C5.63633 7.74631 7.12858 4.35676 8.62676 0.969476C9.11412 -0.132127 10.1249 -0.150769 10.7217 0.207393C11.0366 0.396642 11.2458 0.688143 11.3956 1.02823C11.9067 2.18802 12.4145 3.35007 12.9278 4.50873C14.8955 8.95129 16.8654 13.3933 18.8342 17.8353C19.1712 18.5957 19.5076 19.3561 19.8435 20.117C20.1297 20.7644 20.0154 21.5248 19.5647 21.9773C18.9367 22.6078 17.9463 22.549 17.3878 21.8508C17.253 21.6819 17.1528 21.4937 17.0649 21.2949C15.7462 18.3098 14.4249 15.3253 13.1046 12.3408C12.0884 10.0422 11.0732 7.74348 10.0581 5.44481C10.0365 5.39735 10.015 5.3499 9.981 5.2742Z" fill="white" />
                                <path d="M2.95701 20.8281C2.95701 21.6851 2.29822 22.3743 1.47931 22.376C0.658252 22.3772 -0.000538778 21.6806 3.3064e-07 20.8123C0.000539439 19.9542 0.659869 19.2655 1.47931 19.2661C2.30685 19.2667 2.95755 19.9548 2.95701 20.8281Z" fill="white" />
                            </svg>
                        </div>
                    </div>
                    ...
                    <div className="min-h-full flex flex-col flex-1 mt-6">
                            ...
                            <nav className="flex-1 space-y-2">
                                <CustomLink href="/dashboard">
                                    <a href="#" className={
                                        clsx(
                                            ...
                                            activePath.includes("/dashboard") && "bg-indigo-100 text-indigo-700 border-r-4 border-indigo-700"
                                        )
                                    }>
                                        <svg className=
                                            {
                                                clsx(
                                                    ...
                                                    activePath.includes("/dashboard") && "fill-current text-indigo-700 "

                                                )
                                            } xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 24 24"><path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z" /></svg>
                                    </a>
                                </CustomLink>
                                <CustomLink href="/education">
                                    <a href="#" className={
                                        clsx(
                                            " flex items-center justify-center  p-4 text-sm font-medium transition-all duration-200 fill-current text-gray-700 hover:text-white  hover:bg-indigo-600 group",
                                            activePath.includes("/education") && "bg-indigo-100 text-indigo-700 border-r-4 border-indigo-700"
                                        )
                                    }>
                                        <svg className=
                                            {
                                ...
                                <CustomLink href="/contests">
                                    <a href="#" className={
                                        clsx(
                                            ...
                                            activePath.includes("/contests") && "bg-indigo-100 text-indigo-700 border-r-4 border-indigo-700"
                                        )
                                    }>
                                        <svg className=
                                            {
                                            ...
                                            <path d="M12.7798 13.1229C12.8781 12.9298 13.0169 12.7566 13.1881 12.6133C13.3593 12.47 13.5596 12.3594 13.7774 12.2878C13.9952 12.2163 14.2262 12.1853 14.4571 12.1966C14.6879 12.2079 14.9141 12.2613 15.1225 12.3536C15.5527 12.6022 15.8908 12.9656 16.0918 13.3957C16.2928 13.8257 16.3473 14.302 16.2479 14.7613C16.2071 15.213 15.9919 15.636 15.6415 15.9537C15.2912 16.2713 14.8289 16.4624 14.3388 16.4921M14.3388 16.4921V17.7921M11.4709 18.5613C13.972 17.6921 16.473 17.1767 19.1241 18.1536L19.691 23.3614C18.9401 24.9342 17.8179 26.3323 16.4063 27.4537C14.2972 26.5653 12.6171 24.9905 11.6877 23.0306L11.4709 18.5613Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.7799 13.1231L11.5377 13.2308L12.3714 8.03077C12.1296 7.22308 11.1959 6.4923 10.8041 6.76923C9.22843 11.9769 7.66944 17.1923 7.38599 22.7001L1 29.8462C2.58399 30.0078 4.20133 30.2385 5.46019 29.8462L11.0042 25.7231C11.118 25.6212 11.2542 25.5431 11.4036 25.4939C11.553 25.4447 11.7121 25.4257 11.8701 25.4381C12.0282 25.4505 12.1815 25.494 12.3197 25.5657C12.458 25.6375 12.578 25.7357 12.6715 25.8539L18.574 30.9155C19.9996 31.1847 20.7416 30.7616 21 30.3309L17.6653 26.2462" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" fill="none" />
                                            <path d="M12.3881 8.03092C13.1717 8.11553 15.0725 8.80015 12.7049 6.59245C11.8378 5.76168 10.1038 4.72321 10.8207 6.76937" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.9966 6.88464L18.1905 3.18462L18.7824 1L16.0062 1.53846L12.1379 6.15387" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                ...
                                <CustomLink href="/personal-status">
                                    <a href="#" className={
                                        clsx(
                                            ...
                                            activePath.includes("/personal-status") && "bg-indigo-100 text-indigo-700 border-r-4 border-indigo-700"
                                        )
                                    }>
                                        <svg className=
                                            {
                                ...
                                <CustomLink href="/settings">
                                    <a href="#" className={
                                        clsx(
                                            " flex items-center justify-center p-4 text-sm font-medium transition-all duration-200 fill-current text-gray-700 hover:text-white  hover:bg-indigo-600 group",
                                            activePath.includes("/settings") && "fill current bg-indigo-100 text-indigo-700 border-r-4 border-indigo-700",
                                            "hover:text-white "
                                        )
                                    }>
                                        <svg className=
                        ...
                        <div className="pb-4 flex flex-col gap-y-5 items-center justify-center">
                            <button type="button" className="flex w-8 h-8 items-center justify-center text-sm font-medium text-gray-700 transition-all duration-200 rounded-lg hover:bg-gray-100">
                                <img className="object-cover w-full h-full rounded-full" src="https://landingfoliocom.imgix.net/store/collection/clarity-dashboard/images/vertical-menu/2/avatar-male.png" alt="" />
                            </button>
                            <button type="button" className="flex w-8 h-8 rounded-full items-center justify-center text-sm font-medium text-gray-700 transition-all duration-200 hover:bg-gray-100">
                                <svg className="fill-current text-red-700" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M22.9167 25H10.4167C9.86417 25 9.33427 24.8119 8.94357 24.477C8.55287 24.1421 8.33337 23.6879 8.33337 23.2143V20.5357H10.4167V23.2143H22.9167V1.78571H10.4167V4.46429H8.33337V1.78571C8.33337 1.31211 8.55287 0.85791 8.94357 0.523023C9.33427 0.188137 9.86417 0 10.4167 0H22.9167C23.4692 0 23.9991 0.188137 24.3898 0.523023C24.7805 0.85791 25 1.31211 25 1.78571V23.2143C25 23.6879 24.7805 24.1421 24.3898 24.477C23.9991 24.8119 23.4692 25 22.9167 25Z" fill="#D72B2B" />
                                    <path d="M11.0312 16.5984L14.7604 13.3931H0V11.6074H14.7604L11.0312 8.40199L12.5 7.14307L18.75 12.5002L12.5 17.8574L11.0312 16.5984Z" fill="#D72B2B" />
                                </svg>
            ...
            {
                sidebar && (
                    <div className="hidden shadow-2xl px-5 py-10 drop-shadow-2xl md:flex h-full min-h-screen  flex-col w-1/5">
                        {sidebar}
                    </div>
                )
            }
