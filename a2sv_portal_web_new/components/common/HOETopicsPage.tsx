...
import useGetAllTopicsBySeasonIdQuery, { useGetAllGroupTopicsBySeasonIdQuery } from "../../lib/hooks/useTopics";
...
const HOETopicsPage = (props: Props) => {
  ...
  const [fetchUsers, { data, refetch, loading, }] = useGetAllGroupTopicsBySeasonIdQuery(selectedSeason.value, props.groupId)
