...
const ExpandableSearchInput = (props: Props) => {
    return (
        <div className="relative mx-auto w-max">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className=" absolute inset-y-0 my-auto h-8 w-12 border-r border-transparent  stroke-gray-400 px-3 peer-focus:border-primary peer-focus:stroke-primary " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
