    ...
    <div className="relative flex flex-1 bg-[#F6F6FC] min-h-screen max-h-screen overflow-hidden">
      ...
      >
        ...
        >
          ...
          <h1
            className={clsx(
              "text-primary origin-left font-medium text-xl duration-300 ease-in",
              !expanded && "hidden"
            )}
          >
            A2SV Portal
        ...
        <div className={clsx("mt-6 shadow-lg", expanded ? "px-4" : "px-1")}>
          <hr className="border-gray-300" />
        </div>

        <div className="flex flex-col h-full justify-between my-6">
          <LeftSidebar expanded={expanded} />
          <div
            className={clsx(
              "w-full flex flex-col justify-center gap-y-4 p-2",
          ...
          >
            ...
            >
              ...
              <h1
                className={clsx(
                  "text-primary font-medium text-sm transition-all duration-100 ease-in",
                  !expanded && "hidden"
                )}
              >
      ...
      <main className="flex flex-col flex-1 min-h-screen max-h-screen no-scrollbar overflow-auto ml-0">
