...
type Props = {
  acceptanceInfo: HOAAcceptanceInfo[];
};

const HOAAcceptanceRate = ({ acceptanceInfo }: Props) => {
  return (
    <div>
      <div className="overflow-x-auto relative bg-white border-blue-100 shadow-md sm:rounded-lg border p-4 w-full ">
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {acceptanceInfo ? (
              acceptanceInfo.map(
                (userAcceptanceInfo: HOAAcceptanceInfo, index: number) => {
                  return (
                    <tr
...
export default HOAAcceptanceRate;